...
const RES = { 'margin-bedtime-left.png': 'mBedtimeL', 'margin-bedtime-right.png': 'mBedtimeR', 'margin-sunset-left.png': 'mSunsetL', 'margin-sunset-right.png': 'mSunsetR', 'margin-wildwood-left.png': 'mWildwoodL', 'margin-wildwood-right.png': 'mWildwoodR', 'motif-herbs-colour.png': 'motifColour', 'motif-herbs-wine.png': 'motifWine', 'motif-herbs-moss.png': 'motifMoss' };
...
function JarLabel({ blend, width = 260, assetBase = '../../assets/' }) {
  ...
  return (
    <div data-accent={blend.accent} style={{
      ...
      <img src={res(motif)} alt="" aria-hidden="true" style={{ width: '86%', height: 'auto', mixBlendMode: 'multiply', marginTop: 2 }} />
