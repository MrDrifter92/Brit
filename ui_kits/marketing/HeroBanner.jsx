...
function HeroBanner({ image = '../../assets/photo-table-interior.jpg', height, align = 'center', children }) {
  return (
    <section style={{
      position: 'relative', height: height || 'clamp(260px, 45vw, 460px)', display: 'grid', placeItems: align === 'center' ? 'center' : 'end start',
